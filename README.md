...
## Prerequisites
You must have installed Python along with FontForge. Older versions of FontForge (e.g. 20170731) contain a bug for fontforge.point(). The script should work for versions 20190526 and later.
